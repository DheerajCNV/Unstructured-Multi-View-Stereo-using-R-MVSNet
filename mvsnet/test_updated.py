...
# input path
flags.DEFINE_string('dense_folder', None, 
...
# input parameters
flags.DEFINE_integer('view_num', 5,
                            """Number of images (1 ref image and view_num - 1 view images).""")
flags.DEFINE_integer('max_d', 256, 
                            """Maximum depth step when testing.""")
flags.DEFINE_integer('max_w', 1600, 
                            """Maximum image width when testing.""")
flags.DEFINE_integer('max_h', 1200, 
                            """Maximum image height when testing.""")
flags.DEFINE_float('sample_scale', 0.25, 
                            """Downsample scale for building cost volume (W and H).""")
flags.DEFINE_float('interval_scale', 0.8, 
                            """Downsample scale for building cost volume (D).""")
flags.DEFINE_float('base_image_size', 8, 
                            """Base image size""")
flags.DEFINE_integer('batch_size', 1, 
                            """Testing batch size.""")
flags.DEFINE_bool('adaptive_scaling', True, 
...
flags.DEFINE_bool('inverse_depth', True,
