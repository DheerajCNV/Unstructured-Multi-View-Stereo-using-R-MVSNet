...
# paths
flags.DEFINE_string('blendedmvs_data_root', '/data/BlendedMVS/dataset_low_res', 
                           """Path to dtu dataset.""")
flags.DEFINE_string('eth3d_data_root', '/data/eth3d/lowres/training/undistorted', 
                           """Path to dtu dataset.""")
flags.DEFINE_string('dtu_data_root', '/data/dtu', 
                           """Path to dtu dataset.""")
flags.DEFINE_boolean('train_blendedmvs', False, 
                            """Whether to train.""")
flags.DEFINE_boolean('train_blendedmvg', False, 
                            """Whether to train.""")
flags.DEFINE_boolean('train_dtu', False, 
                            """Whether to train.""")
flags.DEFINE_boolean('train_eth3d', False, 
                            """Whether to train.""")
flags.DEFINE_string('log_folder', '/home/nchiluk6/MVSNet/data/tf_log',
                           """Path to store the log.""")
flags.DEFINE_string('model_folder', '/data/tf_model',
                           """Path to save the model.""")
flags.DEFINE_integer('ckpt_step', 0,
                            """ckpt step.""")
flags.DEFINE_boolean('use_pretrain', False, 
                            """Whether to train.""")

# input parameters
flags.DEFINE_integer('view_num', 3, 
                            """Number of images (1 ref image and view_num - 1 view images).""")
flags.DEFINE_integer('max_d', 192, 
                            """Maximum depth step when training.""")
flags.DEFINE_integer('max_w', 640, 
                            """Maximum image width when training.""")
flags.DEFINE_integer('max_h', 512, 
                            """Maximum image height when training.""")
flags.DEFINE_float('sample_scale', 0.25, 
                            """Downsample scale for building cost volume.""")

# network architectures
flags.DEFINE_string('regularization', 'GRU',
                           """Regularization method.""")
flags.DEFINE_boolean('refinement', False,
...
flags.DEFINE_integer('batch_size', 1, 
                            """Training batch size.""")
flags.DEFINE_integer('epoch', 6, 
                            """Training epoch number.""")
flags.DEFINE_float('base_lr', 0.001,
                          """Base learning rate.""")
flags.DEFINE_integer('display', 1,
                            """Interval of loginfo display.""")
flags.DEFINE_integer('stepvalue', 10000,
                            """Step interval to decay learning rate.""")
flags.DEFINE_integer('snapshot', 5000,
                            """Step interval to save the model.""")
flags.DEFINE_float('gamma', 0.9,
                          """Learning rate decay rate.""")
flags.DEFINE_boolean('online_augmentation', False,
