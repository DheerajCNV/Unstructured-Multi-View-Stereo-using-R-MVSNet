...
flags.DEFINE_string('dtu_data_root', '/data/dtu', 
                           """Path to dtu dataset.""")
flags.DEFINE_string('validate_set', 'dtu', 
                            """Dataset to validate.""")

# params for config
flags.DEFINE_integer('view_num', 3, 
                            """Number of images (1 ref image and view_num - 1 view images).""")
flags.DEFINE_integer('max_d', 256, 
...
flags.DEFINE_float('interval_scale', 1, 
                            """Downsample scale for building cost volume.""")
flags.DEFINE_integer('batch_size', 1, 
                            """training batch size""")
flags.DEFINE_bool('inverse_depth', False,
                           """Apply inverse depth.""")
flags.DEFINE_string('regularization', '3DCNNs', 
                            """Regularization type.""")

# params for paths
flags.DEFINE_string('pretrained_model_ckpt_path', 
                           '/data/tf_model/3DCNNs/BlendedMVS/blended_augmented/model.ckpt',
                           """Path to restore the model.""")
flags.DEFINE_integer('ckpt_step', 150000,
                            """ckpt step.""")
flags.DEFINE_string('validation_result_path', 
